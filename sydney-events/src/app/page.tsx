...
import { Input } from '@/components/ui/input';  // Assuming these are correctly set up
import { Checkbox } from '@/components/ui/checkbox';// Assuming these are correctly set up
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog'; // Assuming these are correctly set up
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'; // Assuming these are correctly set up
import { cn } from "@/lib/utils" // Assuming this is correctly set up
import { motion, AnimatePresence } from 'framer-motion'; // Assuming these are correctly set up
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert" // Assuming these are correctly set up
import { AlertCircle } from "lucide-react" // Assuming these are correctly set up
